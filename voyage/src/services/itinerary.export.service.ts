...
<body>
  <div class="container">
    ...
    <div class="content">
      ...
      <div class="info-box">
        <strong>📅 Dates:</strong> ${this.formatDate(itinerary.startDate)} - ${this.formatDate(itinerary.endDate)}<br>
        ${itinerary.destinations.length > 0 ? `<strong>📍 Destinations:</strong> ${itinerary.destinations.join(', ')}<br>` : ''}
        <strong>📊 Total Items:</strong> ${itinerary.items.length}
      </div>
          ...
          ${items.map(item => `
            <div class="item">
              ...
              <div class="item-details">
                ⏰ ${this.formatTime(item.startDate)} - ${this.formatTime(item.endDate)}<br>
                📍 ${item.location}
      ...
      <p style="margin-top: 30px; color: #6b7280; font-size: 14px;">
        💡 <strong>Tip:</strong> Download the PDF or add to your calendar for offline access!
      </p>
    </div>
