 ...
 */
router.post('/send', apiKeyAuth, async (req: Request, res: Response, next: NextFunction): Promise<void> => {
  try {
 ...
 */
router.post('/send-template', apiKeyAuth, async (req: Request, res: Response, next: NextFunction): Promise<void> => {
  try {
 ...
 */
router.get('/preview/:templateName', apiKeyAuth, (req: Request, res: Response): void => {
